...
# 医学影像数据集统计信息
MEANS['pathmnist'] = [0.741, 0.533, 0.706]
STDS['pathmnist'] = [0.402, 0.821, 0.407]
MEANS['covid'] = [0.485, 0.456, 0.406]
STDS['covid'] = [0.229, 0.224, 0.225]
MEANS['kvasir'] = [0.485, 0.456, 0.406]
STDS['kvasir'] = [0.229, 0.224, 0.225]
